...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      // there (#171).
      testMatch:
        /(service-worker-precache|theme-toggle|theme-mid-take|recorder-selection|recorder-discard-clip|segment-rename|object-menu-focus|edit-history-cue|focus-scroll-measure)\.spec\.ts$/,
