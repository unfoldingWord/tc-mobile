...
| 6   | **Select** — two brackets        | Recorder, on the participant's own recording: **you** open it by tapping segment 3's row (the sound picture, not a button). Ask on the **first** toolbar, the four under the sound picture (bin, disc, triangle, brackets)                               | "Change part of this recording — choose the piece you want to change." Both "it lets me change the recording" and "it lets me choose a piece" count as **Knew it**; the tap opens the editing toolbar, where the same brackets pick the piece |
