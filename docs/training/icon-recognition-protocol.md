...
row's menu uses the same three-lines glyph as row 3, and the brackets in row 6
...
| 3   | **Menu** — three lines           | Segments screen, top corner                                                                                                                                                                                                                              | "Show me what else this screen can do." Close it afterwards (Back).                                                                                                                                                                           |
| 4   | **Finished** — tick              | Segment 1's row menu: **you** open it (its glyph is the same three lines as row 3, already asked), then point at the tick                                                                                                                                | "Tell the app this recording is done."                                                                                                                                                                                                        |
