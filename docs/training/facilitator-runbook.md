...
- **What the screen shows while sharing, and after.** Share is two taps: the
  ...
  - a **tray with a down arrow** means one of two things, and the words under
    ...
    same chapter or book is not sent twice. <!-- source: src/hooks/share-target.ts resolveProvesDelivery, src/hooks/share-flow.ts resolveSendOutcome, src/lib/i18n/en.ts shareUnproven (Frank a446708 P2, #491); not device-verified as of 2026-09-19 -->
...
- **You can listen to the selected audio while editing.** Use Play the
  ...
  <!-- source: src/components/recorder.tsx; src/lib/i18n/en.ts auditionSelection -->
